function CreateWhatsappChatWidget(option = {
    brandSetting: {
        ...
        borderRadius: "25",
        brandImg: "https://mujcentral.in/img/favicon.png",
        brandImgData: null,
        brandName: "WATI",
        ...
        jQuery('#whatsapp_chat_widget').append(`
            <div class='wa-chat-box'>
                <div class='wa-chat-box-header'>
                    <img class='wa-chat-box-brand' onError='this.src= "https://mujcentral.in/img/favicon.png";' src='${option.brandSetting.brandImg}'/>
    ...
    var styles = `
        ...
        .wa-chat-box-content{
            background: url('wpbox/wpchatbg.png');
